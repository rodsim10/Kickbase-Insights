      ...
      <Box sx={{ maxWidth: "1800px", width: "100%", minWidth: "700px", margin: "auto", position: "relative", marginBottom: "100px"}}>
        ...
        <TabContext value={selectedTab}>
          ...
          <TabPanel sx={{ padding: 0 }} value="4">
            ...
            <Paper sx={{ marginTop: "25px"}} elevation={5}>
              <Typography variant="h4" sx={{ padding: "15px" }}>Live Punkte <HelpIcon text="Live Punkte der Manager am aktuellen Spieltag. Mit dem Knopf aktualisieren, anschließend die Seite neu laden."/> <RefreshButtonLivepoints/></Typography>
              <LivePoints />
            </Paper>
          </TabPanel>
